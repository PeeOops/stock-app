            ...
            <div className="grid grid-cols-[1fr_3fr] h-screen font-mono">
                ...
                <div className="flex flex-col items-center bg-slate-800 text-white pt-8">
                    ...
                    <div className="flex flex-col justify-center mt-8 gap-4 w-full">
                        <div id="Dashboard" onClick={handleClickNavigation} role="button" className={`flex flex-row items-center gap-2 hover:bg-gray-300 hover:text-slate-800 cursor-pointer py-1 px-6 md:px-12 ${navigation === "Dashboard" && "bg-gray-300 text-slate-800"} `}>
                            <FontAwesomeIcon icon={faLayerGroup} />
                            <p>Dashboard</p>
                        </div>
                        <div id="Trucks" onClick={handleClickNavigation} role="button" className={`flex flex-row items-center gap-2 hover:bg-gray-300 hover:text-slate-800 cursor-pointer py-1 px-6 md:px-12 ${navigation === "Trucks" && "bg-gray-300 text-slate-800"} `}>
                            <FontAwesomeIcon icon={faList} />
                            <p>Trucks</p>
                        </div>
                        <div id="Inventories" onClick={handleClickNavigation} role="button" className={`flex flex-row items-center gap-2 hover:bg-gray-300 hover:text-slate-800 cursor-pointer py-1 px-6 md:px-12 ${navigation === "Inventories" && "bg-gray-300 text-slate-800"} `}>
                            <FontAwesomeIcon icon={faWarehouse} />
                            <p>Inventories</p>
                        </div>
                        <div id="Suppliers" onClick={handleClickNavigation} role="button" className={`flex flex-row items-center gap-2 hover:bg-gray-300 hover:text-slate-800 cursor-pointer py-1 px-6 md:px-12 ${navigation === "Suppliers" && "bg-gray-300 text-slate-800"} `}>
